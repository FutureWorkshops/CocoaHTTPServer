...
#import "RHHTTPServer.h"
#import "RHHTTPConnection.h"
#import "RHHTTPMessage.h"
#import "RHHTTPResponse.h"
#import "RHHTTPAuthenticationRequest.h"
#import "DDNumber.h"
#import "DDRange.h"
#import "DDData.h"
#import "RHHTTPFileResponse.h"
#import "RHHTTPAsyncFileResponse.h"
...
@interface RHHTTPConnection (PrivateAPI)
...
@implementation RHHTTPConnection
...
- (id)initWithAsyncSocket:(GCDAsyncSocket *)newSocket configuration:(RHHTTPConfig *)aConfig
{
	if ((self = [super init]))
	{
		...
		request = [[RHHTTPMessage alloc] initEmptyRequest];
...
- (BOOL)isAuthenticated
{
	...
	RHHTTPAuthenticationRequest *auth = [[RHHTTPAuthenticationRequest alloc] initWithRequest:request];
...
**/
- (void)addDigestAuthChallenge:(RHHTTPMessage *)response
{
	HTTPLogTrace();
...
**/
- (void)addBasicAuthChallenge:(RHHTTPMessage *)response
{
	HTTPLogTrace();
...
- (void)replyToHTTPRequest
{
	...
	if ([RHWebSocket isWebSocketRequest:request])
	{
		HTTPLogVerbose(@"isWebSocket");
		
		RHWebSocket *ws = [self webSocketForURI:uri];
...
**/
- (RHHTTPMessage *)newUniRangeResponse:(UInt64)contentLength
{
	HTTPLogTrace();
	
	// Status Code 206 - Partial Content
	RHHTTPMessage *response = [[RHHTTPMessage alloc] initResponseWithStatusCode:206 description:nil version:HTTPVersion1_1];
 ...
 * Note: The returned HTTPMessage is owned by the sender, who is responsible for releasing it.
**/
- (RHHTTPMessage *)newMultiRangeResponse:(UInt64)contentLength
{
	HTTPLogTrace();
...
- (void)sendResponseHeadersAndBody
{
	...
	if (!isRangeRequest)
	{
		...
		response = [[RHHTTPMessage alloc] initResponseWithStatusCode:status description:nil version:HTTPVersion1_1];
...
- (NSObject<RHHTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
	...
	{
		return [[RHHTTPFileResponse alloc] initWithFilePath:filePath forConnection:self];
...
- (void)handleVersionNotSupported:(NSString *)version
{
	...
	RHHTTPMessage *response = [[RHHTTPMessage alloc] initResponseWithStatusCode:505 description:nil version:HTTPVersion1_1];
...
- (void)handleAuthenticationFailed
{
	...
	RHHTTPMessage *response = [[RHHTTPMessage alloc] initResponseWithStatusCode:401 description:nil version:HTTPVersion1_1];
	[response setHeaderField:@"Content-Length" value:@"0"];
...
- (void)handleInvalidRequest:(NSData *)data
{
	...
	RHHTTPMessage *response = [[RHHTTPMessage alloc] initResponseWithStatusCode:400 description:nil version:HTTPVersion1_1];
	[response setHeaderField:@"Content-Length" value:@"0"];
...
- (void)handleUnknownMethod:(NSString *)method
{
	...
	RHHTTPMessage *response = [[RHHTTPMessage alloc] initResponseWithStatusCode:405 description:nil version:HTTPVersion1_1];
	[response setHeaderField:@"Content-Length" value:@"0"];
	[response setHeaderField:@"Connection" value:@"close"];
...
- (void)handleResourceNotFound
{
	...
	RHHTTPMessage *response = [[RHHTTPMessage alloc] initResponseWithStatusCode:404 description:nil version:HTTPVersion1_1];
	[response setHeaderField:@"Content-Length" value:@"0"];
...
@implementation RHHTTPConfig

@synthesize server;
@synthesize documentRoot;
@synthesize queue;

- (id)initWithServer:(RHHTTPServer *)aServer documentRoot:(NSString *)aDocumentRoot
{
	if ((self = [super init]))
	{
		server = aServer;
...
- (id)initWithServer:(RHHTTPServer *)aServer documentRoot:(NSString *)aDocumentRoot queue:(dispatch_queue_t)q
{
	if ((self = [super init]))
	{
		server = aServer;
