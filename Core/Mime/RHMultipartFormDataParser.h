...
#import "RHMultipartMessageHeader.h"
...
@class RHMultipartFormDataParser;

//-----------------------------------------------------------------
// protocol MultipartFormDataParser
//-----------------------------------------------------------------

@protocol RHMultipartFormDataParserDelegate <NSObject> 
@optional
- (void) processContent:(NSData*) data WithHeader:(RHMultipartMessageHeader*) header;
- (void) processEndOfPartWithHeader:(RHMultipartMessageHeader*) header;
- (void) processPreambleData:(NSData*) data;
- (void) processEpilogueData:(NSData*) data;
- (void) processStartOfPartWithHeader:(RHMultipartMessageHeader*) header;
@end
...
@interface RHMultipartFormDataParser : NSObject {
NSMutableData*						pendingData;
    NSData*							boundaryData;
    RHMultipartMessageHeader*			currentHeader;
	...
	__weak id<RHMultipartFormDataParserDelegate>                  delegate;
#else
	__unsafe_unretained id<RHMultipartFormDataParserDelegate>     delegate;
#endif	
	int									currentEncoding;
