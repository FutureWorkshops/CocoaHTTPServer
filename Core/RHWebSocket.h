...
- (id)initWithRequest:(RHHTTPMessage *)request socket:(GCDAsyncSocket *)socket;
...
- (void)webSocketDidOpen:(RHWebSocket *)ws;

- (void)webSocket:(RHWebSocket *)ws didReceiveMessage:(NSString *)msg;

- (void)webSocketDidClose:(RHWebSocket *)ws;
